...
public class Latihan02 extends JFrame {
	...
	Latihan02() {
        // shows windows on layer
        setVisible(true);
        // set position windows on screen
        pack();
        setLocationRelativeTo(null);
        // set width and height of windows
        setSize(350, 400);
        // give title to this file
    ...
    private void GenerateUI(Latihan02 frame) {
        ...
        // textFullName.setText("Septiawan Pratama");
        // textFullName.setBackground(Color.LIGHT_BLUE);
